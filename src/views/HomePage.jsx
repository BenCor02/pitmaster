  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Link href="/calculateur" style={{ textDecoration: 'none' }}>
          ...
          >
            ...
            <div style={{ position: 'relative' }}>
              ...
              <div style={{ marginTop: 20 }}>
                <Link href="/calculateur" style={{ textDecoration: 'none', display: 'block' }}>
        ...
        {useMock
          ...
          : small.map((r) => (
              <RecipeCard
                ...
                onClick={() =>
                  router.push(r.slug ? (r.cooking_method ? `/recettes/${r.slug}` : `/guides/${r.slug}`) : '/guides')
                }
              />
            ))}
      </div>
