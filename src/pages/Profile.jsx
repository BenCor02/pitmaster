        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:16 }}>
          <div>
            ...
            <div style={{ fontSize:12, color:'var(--text3)' }}>
              {isPro ? 'Calculs illimités' : `${FREE_LIMIT} calculs par mois`}
            </div>
          </div>
          {!isPro && (
            <button onClick={() => navigate('/pricing')} style={{ padding:'8px 16px', borderRadius:8, border:'none', background:'linear-gradient(135deg,#f48c06,#d44e00)', color:'#fff', fontFamily:"'Syne',sans-serif", fontSize:12, fontWeight:700, cursor:'pointer' }}>
              Passer Pro
            </button>
          )}
        </div>
        ...
        {!isPro && (
          <>
            ...
            <div style={{ fontSize:11, color: remaining === 0 ? '#e85d04' : 'var(--text3)', marginTop:6 }}>
              {remaining === 0
                ? '🔒 Limite atteinte — passe Pro pour continuer'
