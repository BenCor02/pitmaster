-- Supabase foundation runtime complete
-- Adds missing tables/functions/policies used by the current app runtime.
...
-- ---------------------------------------------------------------------------
-- Ensure core columns exist on profiles/site settings (for older partial schemas)
-- ---------------------------------------------------------------------------
