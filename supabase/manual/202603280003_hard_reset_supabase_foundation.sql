-- PATCH: hard reset Supabase foundation for Charbon & Flamme
-- WARNING: destructive reset for the new CMS/auth/calculator foundation.
-- Run this BEFORE the phase 1 seed.
...
-- ─────────────────────────────────────────────────────────────
-- DROP core tables (legacy + fresh foundation)
-- ─────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────
-- RECREATE auth/profile functions
-- ─────────────────────────────────────────────────────────────
...
grant execute on function public.is_adminish() to authenticated, anon;
...
using (
  bucket_id in ('site-media', 'article-media', 'calculator-media')
